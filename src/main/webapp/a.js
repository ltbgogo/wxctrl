...
function(e, exports, t) { !
    function() {
        ...
        function(e, a, n, i, o, c, r, s, l, d, f, u, m, g, p, h, M, v, y) {
            ...
            function(t, a) {
                a.MMPeerUserName !== r.getCurrentUserName() && (a._h || e.heightCalc(a,
                function(e) {
                    a._h = e
                }))
            }),
            ...
            e.imageInit = function(t, a) {
                for (var n, i, o, c = e.imagesMessagesList,
                r = !1,
                i = e.getMsgImg(t.MsgId), s = 0; s < c.length; s++) if (n = c[s], n.msg === t) {
                    r = !0,
                    n.url = i,
                    o = s;
                    break
            ...
            a.screenShot = function() {
                ...
                d.isSupport() ? d.capture({
                    ok: function() {
                        ...
                        function(t) { ! t.BaseResponse || t.BaseResponse && 0 != t.BaseResponse.Ret ? (alert(_("76a7e04")), e.close()) : e.update(c.API_webwxpreview + "?fun=preview&mediaid=" + t.MediaId, t.MediaId)
                        })
                    }
...
function(e, exports) { !
    function() {
        ...
        function(e, t, a, n, i, o, c, r, s, l, d, f) {
            function u(e) {
                function a(e) {
            ...
            function m(a) {
                t.contextMenuList = [];
                var n = c.getContact(a); (n.isRoomContact() || n.isContact()) && (n.isTop() ? t.contextMenuList.push({
                    content: _("84e4fac"),
                    callback: function() {
                        c.setTopContact(a, !1)
                    }
                    ...
                    function(a, n) {
                        ...
                        if (o && !o.isBrandContact() && !o.isShieldUser()) {
                            if (a == _currentUserName) {
                                var r = e.getUnreadMsgsCount(a); (!o.unreadCount || o.unreadCount < r) && (o.unreadCount = e.getUnreadMsgsCount(a)),
...
function(e, exports) { !
    function(e) {
        ...
        function(e, t, a, n, i, o, c, r, s, l, d) {
            var f, u = {},
            m = {
        ...
        function(e, t, a, n, i, o, c, r, s, l, d) {
            ...
            G = {
                ...
                getDisplayName: function(e) {
                    var t = this,
                    a = "";
                    if (r.isRoomContact(t.UserName)) if (a = t.RemarkName || t.NickName, !a && t.MemberList) for (var n = 0,
                ...
                addBatchgetContact: function(e, t, i) {
                    function c(e) {
                        ...
                        function(e) {
                            ...
                            t > -1 && b.splice(t, 1),
                            r.isRoomContact(e.UserName) && e.MemberList && e.MemberList.length ? angular.forEach(e.MemberList,
                            function(t) {
        ...
        function(o, c, r, s, l, d, f, u, m, g) {
            ...
            h = {
                ...
                performClosePop: function(e, t) {
                    var a = e.attr("id"),
                    c = e.scope();
                    c && !c.closing && (c.closing = !0, e.unbind("click"), 1 === n && p.unbind("keydown"), d.$broadcast("root:mmpop:closing", a), g.leave(e,
                    function() {
                ...
                if (o) {
                    ...
                    function() {
                        ...
                        s = setTimeout(function() {
                            ...
                            d = -1,
                            f = 0,
                            u = r.length; f < u && (l == -1 && i.substr(f, 1) != r.substr(f, 1) && (l = f), d == -1 && i.substr(i.length - f - 1, 1) != r.substr(r.length - f - 1, 1) && (d = f), !(l != -1 && d != -1 || u - 1 - d <= l)); ++f);
                            if (l != -1 && d != -1) {
                                if (d = u - 1 - d, d <= l) {
                                    f = l;
                                ...
                                var b = c(g).replace(/&nbsp;/g, " ").replace(new RegExp("<(?!br|" + a.EMOTICON_REG + ").*?>", "g"), "").replace(new RegExp("&lt;(br|" + a.EMOTICON_REG + "/?)&gt;", "g"), "<$1>").replace(/<img.*?class="(.*?)" text="(.*?)" .*?>/g,
                                function() {
...
function(e, exports) {
    ...
    function(e, t, a, n, i, o, c, r, s, l, d, f, u) {
        function m(e) {
            for (var t, a = {},
            n = 0; n < e.length; n++) t = e[n],
            a[t.UserName] = t;
        ...
        return {
            ...
            link: function(t, a, n) {
                ...
                function s(e) { (!t.current || e) && t.contactList.length > 0 && t.keyword && c("header" == t.contactList[0].type ? t.contactList[1] : t.contactList[0])
                }
                var u;
                t.$watch(function() {
